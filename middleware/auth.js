 ...
 * @return {Promise<[boolean, number, string]>}
 */
...
exports.userAuth = async (ctx, next) => {
  let isOk, status, message;
  [isOk, status, message] = await verifyToken(ctx)
